...
class CLEVR_DeepProblog(DeepProblogModel):
    ...
    def normalize_concepts(self, objs):
        ...
        for obj in objs:
            ...
            shape = shape  / Z1  # Normalization
            color = color / Z2  # Normalization
    ...
    def define_herbrand_base(self, n_facts):
        ...
        herbrand_base = torch.cat([torch.cat((eye[i].expand(n_digits, n_digits), eye), dim=1) for i in range(n_digits)], dim=0)
