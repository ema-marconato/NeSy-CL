...
class ValidationDataset(torch.utils.data.Dataset):
    def __init__(self, data: torch.Tensor, targets: np.ndarray, concepts = np.ndarray,
    ...
    def __getitem__(self, index):
        img, target, concept = self.data[index], self.targets[index], self.concepts[index]
