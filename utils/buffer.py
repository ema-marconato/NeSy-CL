...
class Buffer:
    ...
    def __init__(self, buffer_size, device, n_tasks=None, mode='reservoir'):
        ...
        self.attributes = ['examples', 'labels', 'concepts', 'logits', 'task_labels']
    ...
    def add_data(self, examples, labels=None, concepts=None, logits=None, task_labels=None):
        """
        ...
        if not hasattr(self, 'examples'):
            self.init_tensors(examples, labels, concepts, logits, task_labels)
        ...
        for i in range(examples.shape[0]):
            ...
            if index >= 0:
                ...
                if concepts is not None:
                    self.concepts[index] = concepts[i].to(self.device)
